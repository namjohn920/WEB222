...
window.onload = function(){
    ...
    var myContainer = document.querySelector("#image");
    var imageStr = [];

    for(var i=0; i<images.length ; i++){

        imageStr[i] = "<img alt='" + images[i].alt + "'" +  " src='" + images[i].url + "' />" +
                        "<figcaption>" + images[i].caption + "</figcaption>" +"<br>" ;

        myContainer.innerHTML += imageStr[i];
